...
#define SCPI_COMMANDS \
    ...
    SCPI_COMMAND("MEASure[:SCALar]:INPUTVoltage[:DC]?", scpi_cmd_measureScalarInputVoltageDcQ) \
    ...
    SCPI_COMMAND("SIMUlator:VOLTage:EXTernal", scpi_cmd_simulatorVoltageExternal) \
    SCPI_COMMAND("SIMUlator:VOLTage:EXTernal?", scpi_cmd_simulatorVoltageExternalQ) \
